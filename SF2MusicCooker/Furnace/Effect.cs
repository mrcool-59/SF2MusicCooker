namespace SF2MusicCooker.Furnace
{
    public readonly struct Effect
    {
        ...
        public const byte ForceSustain = 0xEF; // Unofficial effect
        ...
        {
            GoTo, GoNext, End, Pan, PanTrinary, NoiseMode, Legato, ForceSustain, Detune, Portamento, Vibrato, VibratoShape, SetTempo,
